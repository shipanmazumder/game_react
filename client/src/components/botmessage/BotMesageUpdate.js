...
import { catgeories, gameUpdate } from "./../../store/actions/gameAction";
...
class BotMessageUpdate extends Component {
  ...
  async componentDidMount() {
    ...
    let game=this.props.updateGame
    const newState = {
      ...game,
      categoryId:this.props.updateGame.categoryId._id,
    };
    this.setState({
      game: newState,
      selectedOption: {
        value: this.props.updateGame.categoryId._id,
        label: this.props.updateGame.categoryId.name,
      },
    });
  }
  submitHandaler = async (event) => {
    ...
    let { game } = this.state;
    await this.props.gameUpdate(game, this.props.history);
  };
